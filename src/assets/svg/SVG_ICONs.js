    ...
    marker: {
      ...
      content: (
        <G>
          <Path
            fill={'#00AE36'}
            d="M7.3,7.9c8.4-8.4,22-8.4,30.4,0c8.4,8.4,8.4,22,0,30.4L22.5,53.5L7.3,38.3C-1.1,29.9-1.1,16.3,7.3,7.9z"
          />
          <Path
            fill={'#FFFFFF'}
            d="M22.5,54.2L6.9,38.7c-8.6-8.6-8.6-22.5,0-31.1C15.5-1,29.5-1,38.1,7.6c8.6,8.6,8.6,22.5,0,31.1L22.5,54.2zM22.5,2.1c-5.4,0-10.8,2-14.8,6.1c-8.2,8.2-8.2,21.5,0,29.7l14.8,14.8L37.3,38c8.2-8.2,8.2-21.5,0-29.7C33.3,4.2,27.9,2.1,22.5,2.1z"
          />
          <Path
            fill={'#FFFFFF'}
            d="M16.3,30.8l0.6-1.7l-9.2-6.8h7.9l-2.3-6.9l6.5,4.7l2.8-8.7l2.8,8.7l6.5-4.7l-2.3,6.9h7.9l-9.2,6.8l0.6,1.7L16.3,30.8z"
          />
          <Path
            fill={'#E30016'}
            d="M14.3,16.9l1.8,5.4h2.9l0.5-1.6L14.3,16.9z M28.8,22.3l1.8-5.4l-5.2,3.7l0.5,1.7H28.8z"
          />
          <Path
            fill={'#E30016'}
            d="M17.1,30.2l0.4-1.3l-8.1-6h10l3.1-9.6l3.1,9.6h10l-8.1,6l0.4,1.3L17.1,30.2z"
          />
        </G>
      ),
    },
